    ...
    <div class="grid half mt-m gap-xl mb-l">
        ...
        <div>
            <?php if($authMethod !== 'ldap' || userCan(\BookStack\Permissions\Permission::UsersManage)): ?>
                ...
                <?php echo $__env->make('form.text', ['name' => 'email', 'disabled' => !userCan(\BookStack\Permissions\Permission::UsersManage)], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endif; ?>
        </div>
    </div>
    <div>
